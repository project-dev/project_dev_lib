========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : DrawerCore
========================================================================


AppWizard が生成した DrawerCore には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには DrawerCore を構成している各ファイルの概要説明が含まれています。
...
DrawerCore.h
	...
	CDrawerCoreApp アプリケーションクラスを宣言します。

DrawerCore.cpp
	このファイルは CDrawerCoreApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) DrawerCore.pch 
