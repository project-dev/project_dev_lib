========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : devgraph
========================================================================


AppWizard が生成した devgraph には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには devgraph を構成している各ファイルの概要説明が含まれています。
...
devgraph.h
	...
	CDevgraphApp アプリケーションクラスを宣言します。

devgraph.cpp
	このファイルは CDevgraphApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) devgraph.pch 
