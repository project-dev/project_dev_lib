========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : devXML
========================================================================


AppWizard が生成した devXML には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには devXML を構成している各ファイルの概要説明が含まれています。
...
devXML.h
	...
	CDevXMLApp アプリケーションクラスを宣言します。

devXML.cpp
	このファイルは CDevXMLApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) devXML.pch 
