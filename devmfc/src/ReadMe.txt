========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : devmfc
========================================================================


AppWizard が生成した devmfc には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには devmfc を構成している各ファイルの概要説明が含まれています。
...
devmfc.h
	...
	CDevmfcApp アプリケーションクラスを宣言します。

devmfc.cpp
	このファイルは CDevmfcApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) devmfc.pch 
